...
<script type="text/ecmascript-6">
    ...
    import { once, addClass, removeClass } from '../../services/utils';
        ...
        methods: {
            ...
            translate(element, offset, speed, callback) {
                if (speed) {
                    ...
                    setTimeout(transitionEndCallback, speed + 10); // webkitTransitionEnd maybe not fire on lower version android.
                } else {
                    element.style.webkitTransition = '';
                    element.style.webkitTransform = `translate3d(${offset}px, 0, 0)`;
                }
