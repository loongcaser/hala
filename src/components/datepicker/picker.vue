<template>
    <div ha-picker class="ha-datepicker" :class="{'active': state == 1}">
        <div class="dp-header">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        destroyed() {
            document.body.removeChild(document.querySelector('[ha-picker]'))
        },

        methods: {
            show() {
                $backdrop.show().then(() => {
                    let backdrop = document.querySelector('[ha-backdrop]');
                    backdrop.onclick = () => {
